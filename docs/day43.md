...
|-----:|:---------------|:-----------------------------------------------------------|:--------------------------------------------------------------------------|:------|
| 8600 | fable          | n.神话，传说；n.谎言，虚构                                 | 1. story of upernatural happenings; 2. statement made in order to deceive | r1    |
| 8601 | proofread      | v.校对                                                     | find errors                                                               | r3    |
| 8602 | dilute         | vt.稀释；adj.经稀释的                                      | 1. less concentrated; 2. low strength, concentration                      | r0    |
| 8603 | extant         | adj.现存的                                                 | not destroyed                                                             | r2    |
| 8604 | verify         | vt.校验，证实                                              | determine accuracy                                                        | r3    |
| 8605 | fleeting       | adj.稍纵即逝的，短暂的                                     | for a short time                                                          | r0    |
| 8606 | scourge        | n.祸害                                                     | source of harm                                                            | r1    |
| 8607 | tarnish        | vt.玷污                                                    | morally bad                                                               | r2    |
| 8608 | visionary      | adj.空想的，不切实际的；adj.有远见的                       | 1. guided by ideals; 2. foresight                                         | r0    |
| 8609 | interdict      | vt.禁止                                                    | forbid                                                                    | r1    |
| 8610 | inveterate     | adj.根深蒂固的                                             | firmly established                                                        | r3    |
| 8611 | rational       | adj.理性的                                                 | based on reasoning                                                        | r2    |
| 8612 | comprehend     | vt.理解，了解；vt.包括，包含                               | 1. grasp; 2. contain or hold within                                       | r2    |
| 8613 | deracinate     | vt.根除                                                    | pull out                                                                  | r3    |
| 8614 | inane          | adj.空洞的                                                 | lacking significance                                                      | r0    |
| 8615 | proscribe      | v.禁止，排斥                                               | forbid                                                                    | r1    |
| 8616 | exterminate    | vt.根除，消灭                                              | killing off                                                               | r3    |
| 8617 | don            | vt.穿上                                                    | put on                                                                    | r0    |
| 8618 | teetotalism    | n.禁酒                                                     | abstinence from alcoholic                                                 | r1    |
| 8619 | flaw           | n.瑕疵，缺点；v.降低，破坏，使不完美                       | 1. imperfection; 2. reduce perfection                                     | r2    |
| 8620 | aphorism       | n.格言，警句                                               | short witty                                                               | r3    |
| 8621 | protrude       | v.突出                                                     | project                                                                   | r0    |
| 8622 | cloying        | adj.甜得发腻的；感情用事的                                 | excessively sweet                                                         | r2    |
| 8623 | uncanny        | adj.离奇的，奇异的                                         | extraordinary or abnormal                                                 | r1    |
| 8624 | thorny         | adj.棘手的                                                 | difficulties                                                              | r3    |
| 8625 | discrete       | adj.离散的，不连续的                                       | separate                                                                  | r1    |
| 8626 | plummet        | v.突然下降                                                 | decline suddenly                                                          | r0    |
| 8627 | blandishment   | n.甜言蜜语，讨好某人的话                                   | something that tends to coax or cajole                                    | r2    |
| 8628 | spiny          | adj.棘手的，麻烦的                                         | requiring exceptional skill                                               | r3    |
| 8629 | sulk           | vi.生气，愠怒                                              | resentment                                                                | r2    |
| 8630 | tangent        | n./adj.离题(的)，不相关(的)                                | irrelevant                                                                | r1    |
| 8631 | plunge         | v.突然下降                                                 | descend suddenly                                                          | r0    |
| 8632 | dissemble      | v.用假象隐藏真相，掩饰                                     | False                                                                     | r2    |
| 8633 | recapitulate   | v./v.概括，摘要                                            | make into a short statement                                               | r3    |
| 8634 | stitch         | n.突然剧痛                                                 | sharp unpleasant sensation                                                | r0    |
...
| 8670 | subsidiary     | adj.次要的                                                 | secondary importance                                                      | r3    |
...
| 8706 | plummet        | v.突然下降                                                 | decline suddenly                                                          | r1    |
...
| 8742 | promulgate     | v.正式宣布                                                 | make known                                                                | r3    |
...
| 8778 | bluff          | adj.直率的，(说话)直截了当的；vt.欺骗                      | 1. direct, brief, potentially rude; 2. deceive                            | r2    |
